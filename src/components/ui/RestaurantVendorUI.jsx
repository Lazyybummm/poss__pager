          ...
          <nav className="flex items-center gap-1">
            ...
            },
            {
              ...
              >
                ...
                {item.badge > 0 && (
                  <span className={`${orders.length >= settings.kitchenCapacity ? 'bg-red-600' : 'bg-blue-600'} text-white text-[10px] min-w-4.5 h-4.5 rounded-full flex items-center justify-center`}>
                    {item.badge}
                  </span>
                )}
              </button>
